"""Testes do formatador de relatório compartilhado.

A orquestração real é testada em tests/ingestion/test_orquestrador.py.
"""
...
def test_formatar_relatorio_com_sucesso_inclui_contadores() -> None:
    ...
    saida = formatar_relatorio(relatorio)
